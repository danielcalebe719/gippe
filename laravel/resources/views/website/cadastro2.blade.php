...
<form action="{{ url('website/cadastroCompletar') }}" method="POST">
    @csrf
    <input type="hidden" name="idClientes" value="{{ Auth::guard('cliente')->user()->idClientes }}">
    ...
    <div class="input-group">
        ...
        <input type="text" id="cpf" name="cpf" maxlength="11" required value="">
    </div>
    <div class="input-group">
        <label for="telefone">Telefone:</label>
        <input type="text" id="telefone" name="telefone" required value="">
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
        ...
        <input type="text" id="cep" name="cep" maxlength="8" required value="">
    </div>
    <div class="input-group">
        <label for="rua">Rua:</label>
        <input type="text" id="rua" name="rua" maxlength="40" required value="">
    </div>
    <div style="display: flex; flex-direction: row;">
        <div class="input-group" style="max-width: 50%;">
            <label for="numero">Número:</label>
            <input type="text" id="numero" name="numero" maxlength="5" required value="">
        </div>
        <div class="input-group" style="max-width: 50%;">
            <label for="complemento">Complemento:</label>
            <input type="text" id="complemento" name="complemento" maxlength="20" value="">
        </div>
    </div>
    <div class="input-group">
        <label for="bairro">Bairro:</label>
        <input type="text" id="bairro" name="bairro" maxlength="25" required value="">
    </div>
    <div class="input-group" style="max-width: 95%; margin-right: 20px;">
        <label for="cidade">Cidade:</label>
        <input type="text" id="cidade" name="cidade" maxlength="40" required value="">
    </div>
    <div class="input-group">
        <label for="tipo">Tipo de Endereço:</label>
        <select name="tipo" id="tipo" required>
            <option value="Selecione o tipo de Endereço">Selecione o tipo de Endereço</option>
