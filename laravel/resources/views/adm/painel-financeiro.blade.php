    ...
    <div>
                                                ...
                                                <div class="btn-toolbar" role="toolbar"
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="Ações do Pedido">
                                                        <button class="btn btn-info btn-sm"
                                                            onclick="mostrarDetalhes('{{ $gasto->id }}')"
                                                            data-toggle="modal">
                                                            Detalhes
                                                        </button>
                                                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formAdicionarAgendamento" method="POST" action="/adm/gastos/guardar">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="valor" name="valor" required>
                            </div>
                            <div class="form-group">
                                <label for="dataFim">Departamento:</label>
                                <input type="date" class="form-control" id="departamento" name="departamento" required>
                            </div>
        ...
        <script>
            ...
            document.getElementById('confirmarExclusao').addEventListener('click', function() {
                ...
                fetch(`/adm/gastos/remover/${idGasto}`, {
                        method: 'GET',
                        headers: {
        ...
        <div class="modal fade" id="modalEditarGasto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formEditarAgendamento" method="POST" action="/adm/gastos/guardar"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="editarValor" name="valor" required>
                            </div>
                            <div class="form-group">
                                <label for="editDataFim">Departamento</label>
                                <input type="date" class="form-control" id="editarDepartamento" name="departamento"
                                    required>
                            </div>
